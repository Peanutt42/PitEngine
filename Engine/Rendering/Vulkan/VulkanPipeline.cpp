...
std::vector<char> Pipeline::_ReadFile(const std::string& filepath) {
	...
	if (!file.is_open())
		PIT_ENGINE_ERR("Failed to open file: {}", filepath);
...
void Pipeline::_CreateGraphicsPipeline(const std::string& vertFilepath,
									   const std::string& fragFilepath,
									   const PipelineConfigInfo& configInfo) {
	...
	if (vkCreateGraphicsPipelines(
		...
		PIT_ENGINE_ERR("Failed to create graphics pipeline!");
	}
...
void Pipeline::_CreateShaderModule(const std::vector<char>& code, VkShaderModule* shaderModule) {
	...
	if (vkCreateShaderModule(m_Device.device(), &createInfo, nullptr, shaderModule) != VK_SUCCESS)
		PIT_ENGINE_ERR("Failed to create shader module");
}